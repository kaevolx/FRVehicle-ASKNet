...
class ASKblock(nn.Module):
    def __init__(self, dim):
        ...
        self.conv_squeeze = nn.Conv2d(2, 2, kernel_size=(3,7), padding=(1,3))
...
class Attention(nn.Module):
    def __init__(self, d_model):
        ...
        self.spatial_gating_unit = ASKblock(d_model)
...
class ASKNet(BaseModule):
    ...
    def init_weights(self):
        ...
        if self.init_cfg is None:
            ...
            super(ASKNet, self).init_weights()
